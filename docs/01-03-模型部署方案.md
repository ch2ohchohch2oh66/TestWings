...
> **文档定位**：本文档是**模型选型和部署的唯一权威文档**，包含所有关于VL/LLM模型选型、为什么需要分别部署、部署方案、工程实践评估等内容。其他文档中的模型选型相关内容应引用本文档，避免重复。
...
#### 模型文件结构
```
app/src/main/assets/models/vl/
├── qwen_vl_chat_int8.onnx  # Qwen-VL模型（INT8量化）
└── tokenizer.json          # 分词器
```
